...
public class NameService {
	    ...
	    public void addFemaleFirstName(String name){
	    	try {
	    		...
	    		throw new DuplicateNameException("The female first name exist.");
			}
	    }
	    ...
	    public void addMaleFirstName(String name) throws IOException{
	    	if (maleFirstNames.contains(name)) {
				throw new DuplicateNameException("The male first name exist.");
			}
	    ...
	    public void addLastName(String lastName) {
			try {
				...
				throw new DuplicateNameException("The last name exist.");
			}
		}
}
